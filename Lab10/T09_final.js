...
function fn_select_color(color){
	if(color === 1){
		return 	gl.clearColor(1.0, 0.0, 0.0, 1.0);
	}
	else if(color === 2){
		return 	gl.clearColor(0.0, 0.0, 1.0, 1.0);
	}
	else if(color === 3){
		return 	gl.clearColor(0.0, 1.0, 0.0, 1.0);
	}
	else{
		return 	gl.clearColor(0.0, 0.0, 0.0, 1.0);
	}
}
