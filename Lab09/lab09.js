...
function fn_update_fov(fov)
{
	document.getElementById("textFOV").value = fov;
...
function renderScene() {
	let fov = document.getElementById("fov_range").value;
	let width = document.getElementById("helloapicanvas").width;
	let height = document.getElementById("helloapicanvas").height;
	...
	mat4.perspective(pMat,		fn_update_fov(fov),		width/height, 1, 3);
	mat4.lookAt(vMat, [0,0,2], [0,0,0], [0,1,0]);
